В отличие от [[bag-of-words]], учитывается не только частота появления токена, но и не учитываются слова, которые встречаются в каждом сэмпле. Чем чаще слово встречается, тем меньше его значение.
